        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column nav-flat" data-widget="treeview" role="menu" data-accordion="false">
                <?php if($_SESSION['login_type'] ==2): ?>
                    ...
                    <li class="nav-item">
                        <a href="./index.php?page=upload_photo" class="nav-link nav-upload_photo">
                    ...
                    <ul class="nav nav-treeview">
                        ...
                        $status_arr = array("Item Accepted<br/>by Courier", "Collected", "Shipped", "In-Transit",
                            "Arrived At<br/>Destination", "Out for Delivery", "Ready to Pickup", "Delivered",
                            "Picked-up", "Unsuccessful<br/>Delivery Attempt");
                ...
                <?php elseif($_SESSION['login_type'] == 3): ?>
                    ...
                    <li class="nav-item">
                        <a href="index.php?page=feedback_form" class="nav-link nav-feedback_form">
